...
/* Ice Lake-LP */
static const char *const icelake_pch_h_group_names[] = {
	/* GPP_G */
	"GPP_G0", "SD3_CMD",
	"GPP_G1", "SD3_D0",
	"GPP_G2", "SD3_D1",
...
static const struct gpio_group icelake_pch_h_group_g = {
	...
	.pad_count	= 8,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[0 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_b = {
	...
	.pad_count	= 26,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[8 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_a = {
	...
	.pad_count	= 25,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[34 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_h = {
	...
	.pad_count	= 82 - 59 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[59 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_d = {
	...
	.pad_count	= 103 - 83 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[83 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_f = {
	...
	.pad_count	= 123 - 104 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[104 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_vgpio_0 = {
	...
	.pad_count	= 152 - 124 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[124 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_c = {
	...
	.pad_count	= 176 - 153 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[153 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_hvcmos = {
	...
	.pad_count	= 182 - 177 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[177 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_e = {
	...
	.pad_count	= 206 - 183 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[183 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_jtag = {
	...
	.pad_count	= 215 - 207 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[207 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_r = {
	...
	.pad_count	= 223 - 216 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[216 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_s = {
	...
	.pad_count	= 231 - 224 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[224 * 2],
};
...
static const struct gpio_group icelake_pch_h_group_spi = {
	...
	.pad_count	= 240 - 232 + 1,
	.func_count	= 2,
	.pad_names	= &icelake_pch_h_group_names[232 * 2],
};
