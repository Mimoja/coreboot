...
void mainboard_memory_init_params(FSPM_UPD *mupd)
{
	...
	mainboard_fill_dq_map_data(&mem_cfg->DqByteMapCh1);
	mainboard_fill_dqs_map_ch0_data(&mem_cfg->DqsMapCpu2DramCh0);
	mainboard_fill_dqs_map_ch1_data(&mem_cfg->DqsMapCpu2DramCh1);
